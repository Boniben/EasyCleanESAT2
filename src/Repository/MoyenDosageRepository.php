...
/**
 * @extends ServiceEntityRepository<MoyenDosage>
 */
class MoyenDosageRepository extends ServiceEntityRepository
{
    ...
    //    public function findOneBySomeField($value): ?MoyenDosage
    //    {
    //        return $this->createQueryBuilder('m')
    //            ->andWhere('m.exampleField = :val')
    //            ->setParameter('val', $value)
